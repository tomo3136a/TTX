...
static LPSTR TTXGetPath_v4(PTTSet ts, UINT uid)
{
	...
	switch(uid)
	{
        ...
        case ID_SETUPFNAME:
			...
			break;
        case ID_KEYCNFNM:
			s = ts->reserve_KeyCnfFN;
			break;
        case ID_LOGFN:
			s = ts->LogFN;
			break;
        case ID_MACROFN:
			s = ts->reserve_MacroFN;
			break;
        case ID_UILANGUAGEFILE:
			s = ts->reserve_UILanguageFile;
			break;
        case ID_UILANGUAGEFILE_INI:
			s = ts->reserve_UILanguageFile_ini;
			break;
        case ID_EXEDIR:
			s = ts->HomeDir;
			break;
...
static LPTSTR TTXGetPath_v5(PTTSet ts, UINT uid)
{
	...
	switch(uid)
	{
        ...
        case ID_UILANGUAGEFILE:
			...
			break;
        case ID_UILANGUAGEFILE_INI:
			s = ts->reserve_UILanguageFileW_ini;
			break;
        case ID_EXEDIR:
			s = ts->ExeDirW;
			break;
...
static BOOL TTXSetPath_v4(PTTSet ts, UINT uid, LPSTR s)
{
	...
	switch(uid)
	{
        ...
        case ID_SETUPFNAME:
			...
			break;
        case ID_KEYCNFNM:
			strncpy_s(ts->reserve_KeyCnfFN, sizeof(ts->reserve_KeyCnfFN), s, _TRUNCATE);
			break;
        case ID_LOGFN:
			strncpy_s(ts->LogFN, sizeof(ts->LogFN), s, _TRUNCATE);
			break;
        case ID_MACROFN:
			strncpy_s(ts->reserve_MacroFN, sizeof(ts->reserve_MacroFN), s, _TRUNCATE);
			break;
        case ID_UILANGUAGEFILE:
			strncpy_s(ts->reserve_UILanguageFile_ini, sizeof(ts->reserve_UILanguageFile), s, _TRUNCATE);
			break;
        case ID_UILANGUAGEFILE_INI:
			strncpy_s(ts->reserve_UILanguageFile_ini, sizeof(ts->reserve_UILanguageFile_ini), s, _TRUNCATE);
			break;
        case ID_EXEDIR:
			return FALSE;
        case ID_LOGDIR:
			return FALSE;
        case ID_FILEDIR:
			strncpy_s(ts->reserve_FileDir, sizeof(ts->reserve_FileDir), s, _TRUNCATE);
			break;
        case ID_LOGDEFAULTPATH:
			return FALSE;
		default:
...
static BOOL TTXSetPath_v5(PTTSet ts, UINT uid, LPTSTR s)
{
	...
	switch(uid)
	{
        ...
        case ID_KEYCNFNM:
			...
			p = toMB(s);
			strncpy_s(ts->reserve_KeyCnfFN, sizeof(ts->reserve_KeyCnfFN), p, _TRUNCATE);
			free(p);
			break;
        case ID_LOGFN:
			free(ts->LogFNW);
        ...
        case ID_MACROFN:
			...
			p = toMB(s);
			strncpy_s(ts->reserve_MacroFN, sizeof(ts->reserve_MacroFN), p, _TRUNCATE);
			free(p);
			break;
        case ID_UILANGUAGEFILE:
			...
			p = toMB(s);
			strncpy_s(ts->reserve_UILanguageFile, sizeof(ts->reserve_UILanguageFile), p, _TRUNCATE);
			free(p);
			break;
        case ID_UILANGUAGEFILE_INI:
			free(ts->reserve_UILanguageFileW_ini);
			ts->reserve_UILanguageFileW_ini = _wcsdup(s);
			p = toMB(s);
			strncpy_s(ts->reserve_UILanguageFile_ini, sizeof(ts->reserve_UILanguageFile_ini), p, _TRUNCATE);
			free(p);
			break;
        case ID_EXEDIR:
			free(ts->ExeDirW);
        ...
        case ID_FILEDIR:
			...
			p = toMB(s);
			strncpy_s(ts->reserve_FileDir, sizeof(ts->reserve_FileDir), p, _TRUNCATE);
			free(p);
			break;
        case ID_LOGDEFAULTPATH:
